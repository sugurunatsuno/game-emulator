...
readonly DIRECT_VULKAN_REMOTE_DIR="/data/local/tmp/tft-direct-vulkan$EDITION_SUFFIX"
...
readonly ANGLE_OPENGL_REMOTE_DIR="/data/local/tmp/tft-angle-opengl$EDITION_SUFFIX"
